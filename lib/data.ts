...
export const QUESTIONS: QuizQuestion[] = [
  ...
  { id: 'tr4', category: 'turkce', difficulty: 'Kolay', question: '"Geliyorum" fiilinin kipi ve zamanı nedir?', options: ['Şimdiki zaman – haber kipi', 'Gelecek zaman – dilek kipi', 'Geniş zaman – haber kipi', 'Geçmiş zaman – dilek kipi', 'Duyulan geçmiş zaman – haber kipi'], answer: 0, explanation: '"-yor" eki şimdiki zaman ekidir ve haber (bildirme) kiplerindendir.' },
  { id: 'tr5', category: 'turkce', difficulty: 'Kolay', question: '"Öğrenciler sınavda çok heyecanlandı." cümlesinin öznesi hangisidir?', options: ['Öğrenciler', 'sınavda', 'çok', 'heyecanlandı', 'sınav'], answer: 0, explanation: 'Yükleme sorulan "kim?" sorusunun yanıtı öznedir: Kim heyecanlandı? → Öğrenciler.' },
  { id: 'tr6', category: 'turkce', difficulty: 'Orta', question: '"Güzel" sözcüğü hangi cümlede isim olarak kullanılmıştır?', options: ['Güzel günler göreceğiz.', 'Çok güzel şarkı söylüyor.', 'Güzeli herkes sever.', 'Güzel güzel konuştu.', 'Bu güzel bir haber.'], answer: 2, explanation: '"Güzeli" sözcüğü adlaşmış sıfattır; cümlede isim göreviyle kullanılmıştır.' },
  { id: 'tr7', category: 'turkce', difficulty: 'Orta', question: '"Bu konuyu mutlaka ve mutlaka öğrenmelisin." cümlesindeki anlatım bozukluğunun nedeni nedir?', options: ['Gereksiz sözcük kullanımı', 'Özne – yüklem uyumsuzluğu', 'Ek yanlışlığı', 'Tamlama yanlışlığı', 'Dolaylı tümleç eksikliği'], answer: 0, explanation: 'Aynı anlama gelen sözcüklerin birlikte kullanılması gereksiz sözcük kullanımından kaynaklanır.' },
  { id: 'tr8', category: 'turkce', difficulty: 'Zor', question: '"Sınava düzenli çalışan öğrenciler başarılı oldu." cümlesinde "düzenli çalışan" grubunun türü nedir?', options: ['Sıfat tamlaması', 'İsim tamlaması', 'Sıfat-fiil grubu', 'Zarf-fiil grubu', 'İsim-fiil grubu'], answer: 2, explanation: '"-an" eki sıfat-fiil ekidir; ifade sıfat-fiil grubudur.' },
  { id: 'mt1', category: 'matematik', difficulty: 'Kolay', question: '2³ + 3² işleminin sonucu kaçtır?', options: ['14', '17', '13', '19', '21'], answer: 1, explanation: '2³ = 8 ve 3² = 9 olduğundan 8 + 9 = 17 bulunur.' },
  { id: 'mt2', category: 'matematik', difficulty: 'Kolay', question: 'Bir sayının %25\'i 60 ise bu sayı kaçtır?', options: ['180', '200', '240', '220', '300'], answer: 2, explanation: 'Sayının dörtte biri 60 ise sayı 60 × 4 = 240 olur.' },
  { id: 'mt3', category: 'matematik', difficulty: 'Kolay', question: 'EBOB(12, 18) kaçtır?', options: ['2', '3', '6', '36', '72'], answer: 2, explanation: '12 = 2²×3, 18 = 2×3² olduğundan ortak bölenlerin en büyüğü 2×3 = 6\'dır.' },
  { id: 'mt4', category: 'matematik', difficulty: 'Orta', question: 'x + 7 = 3x − 9 denklemini sağlayan x değeri kaçtır?', options: ['8', '6', '4', '2', '10'], answer: 0, explanation: '7 + 9 = 3x − x → 16 = 2x → x = 8 bulunur.' },
  { id: 'mt5', category: 'matematik', difficulty: 'Orta', question: 'Ardışık üç çift sayının toplamı 48 ise en büyüğü kaçtır?', options: ['14', '16', '18', '20', '22'], answer: 2, explanation: 'Ortanca sayı 48 ÷ 3 = 16\'dır. Sayılar 14, 16, 18 olur; en büyüğü 18\'dir.' },
  { id: 'mt6', category: 'matematik', difficulty: 'Orta', question: 'Bir işçi bir işi 12 günde, diğeri 6 günde bitiriyor. İkisi birlikte kaç günde bitirir?', options: ['2', '3', '4', '8', '6'], answer: 2, explanation: '1/12 + 1/6 = 3/12 = 1/4 olduğundan iş birlikte 4 günde biter.' },
  { id: 'mt7', category: 'matematik', difficulty: 'Orta', question: '5! / 3! işleminin sonucu kaçtır?', options: ['2', '10', '20', '120', '24'], answer: 2, explanation: '5!/3! = 5×4 = 20\'dir (3!\'ler sadeleşir).' },
  { id: 'mt8', category: 'matematik', difficulty: 'Zor', question: 'Alanı 49 cm² olan karenin çevresi kaç cm\'dir?', options: ['14', '21', '28', '35', '32'], answer: 2, explanation: 'Karenin bir kenarı √49 = 7 cm\'dir. Çevre = 4 × 7 = 28 cm olur.' },
  { id: 'ta1', category: 'tarih', difficulty: 'Kolay', question: 'Malazgirt Meydan Muharebesi hangi yılda yapılmıştır?', options: ['1040', '1071', '1176', '1243', '1171'], answer: 1, explanation: 'Sultan Alparslan komutasındaki Selçuklu ordusu 1071\'de Bizans\'ı yenerek Anadolu\'nun kapılarını Türklere açtı.' },
  { id: 'ta2', category: 'tarih', difficulty: 'Kolay', question: 'İstanbul hangi Osmanlı padişahı döneminde fethedilmiştir?', options: ['Orhan Bey', 'I. Murat', 'Fatih Sultan Mehmet', 'Yavuz Sultan Selim', 'Kanuni Sultan Süleyman'], answer: 2, explanation: 'İstanbul, 29 Mayıs 1453\'te II. Mehmet (Fatih Sultan Mehmet) tarafından fethedildi.' },
  { id: 'ta3', category: 'tarih', difficulty: 'Kolay', question: 'TBMM hangi tarihte açılmıştır?', options: ['19 Mayıs 1919', '23 Nisan 1920', '29 Ekim 1923', '30 Ağustos 1922', '30 Ağustos 1920'], answer: 1, explanation: 'Türkiye Büyük Millet Meclisi 23 Nisan 1920\'de Ankara\'da açılmıştır.' },
  { id: 'ta4', category: 'tarih', difficulty: 'Orta', question: 'Miryakefalon Savaşı\'nın (1176) en önemli sonucu nedir?', options: ['Anadolu\'nun kesin Türk yurdu olması', 'İstanbul\'un fethedilmesi', 'Haçlıların Anadolu\'dan atılması', 'Moğol baskısının sona ermesi', 'Bizansın güçlenmesi'], answer: 0, explanation: 'II. Kılıçarslan\'ın Bizans\'ı yenmesiyle Anadolu\'nun Türk yurdu olduğu kesinleşti.' },
  { id: 'ta5', category: 'tarih', difficulty: 'Kolay', question: 'Lozan Barış Antlaşması hangi yılda imzalanmıştır?', options: ['1920', '1921', '1922', '1923', '1924'], answer: 3, explanation: 'Lozan Antlaşması 24 Temmuz 1923\'te imzalanmış, yeni Türk devletinin bağımsızlığı tanınmıştır.' },
  { id: 'ta6', category: 'tarih', difficulty: 'Kolay', question: 'Cumhuriyet hangi tarihte ilan edilmiştir?', options: ['23 Nisan 1920', '29 Ekim 1923', '3 Mart 1924', '1 Kasım 1922', '23 Nisan 1923'], answer: 1, explanation: 'Cumhuriyet 29 Ekim 1923\'te ilan edilmiş, Mustafa Kemal Atatürk ilk cumhurbaşkanı seçilmiştir.' },
  { id: 'ta7', category: 'tarih', difficulty: 'Kolay', question: 'Osmanlı Devleti\'nin kurucusu kimdir?', options: ['Ertuğrul Gazi', 'Osman Bey', 'Orhan Bey', 'I. Murat', 'Süleyman Şah'], answer: 1, explanation: 'Osmanlı Devleti 1299\'da Osman Bey tarafından Söğüt-Domaniç çevresinde kurulmuştur.' },
  { id: 'ta8', category: 'tarih', difficulty: 'Orta', question: 'Sakarya Meydan Muharebesi\'nde Türk ordusunun başkomutanı kimdir?', options: ['İsmet İnönü', 'Fevzi Çakmak', 'Mustafa Kemal Atatürk', 'Kazım Karabekir', 'Refet Bele'], answer: 2, explanation: 'TBMM\'nin verdiği Başkomutanlık yetkisiyle Sakarya\'da ordunun başında Mustafa Kemal Atatürk vardı.' },
  { id: 'co1', category: 'cografya', difficulty: 'Kolay', question: 'Türkiye\'nin nüfusu en kalabalık ili hangisidir?', options: ['Ankara', 'İzmir', 'İstanbul', 'Bursa', 'Antalya'], answer: 2, explanation: 'İstanbul, 15 milyonu aşan nüfusuyla Türkiye\'nin en kalabalık ilidir.' },
  { id: 'co2', category: 'cografya', difficulty: 'Kolay', question: 'Türkiye\'de en fazla yağış alan bölge hangisidir?', options: ['Akdeniz', 'Karadeniz', 'Ege', 'İç Anadolu', 'Marmara'], answer: 1, explanation: 'Karadeniz Bölgesi, özellikle Doğu Karadeniz kıyıları her mevsim yağış alır.' },
  { id: 'co3', category: 'cografya', difficulty: 'Kolay', question: 'Van Gölü hangi coğrafi bölgemizde yer alır?', options: ['İç Anadolu', 'Doğu Anadolu', 'Güneydoğu Anadolu', 'Akdeniz', 'Marmara'], answer: 1, explanation: 'Türkiye\'nin en büyük gölü olan Van Gölü, Doğu Anadolu Bölgesi\'ndedir.' },
  { id: 'co4', category: 'cografya', difficulty: 'Orta', question: 'Tamamı ülke sınırları içinde kalan en uzun akarsuyumuz hangisidir?', options: ['Fırat', 'Kızılırmak', 'Yeşilırmak', 'Sakarya', 'Dicle'], answer: 1, explanation: 'Kızılırmak (1355 km) doğduğu gibi denize de Türkiye\'de dökülen en uzun akarsudur.' },
  { id: 'co5', category: 'cografya', difficulty: 'Orta', question: 'Soma linyit yatakları hangi ilimizdedir?', options: ['Kütahya', 'Manisa', 'Muğla', 'Balıkesir', 'Denizli'], answer: 1, explanation: 'Soma, Manisa iline bağlıdır ve önemli linyit havzalarındandır.' },
  { id: 'co6', category: 'cografya', difficulty: 'Kolay', question: 'Fındık üretiminin en yoğun olduğu bölgemiz hangisidir?', options: ['Marmara', 'Karadeniz', 'Ege', 'Akdeniz', 'Doğu Anadolu'], answer: 1, explanation: 'Türkiye dünya fındık üretiminde ilk sıradadır; üretim Karadeniz\'de yoğunlaşmıştır.' },
  { id: 'co7', category: 'cografya', difficulty: 'Zor', question: 'Türkiye\'nin matematik (mutlak) konumu nedir?', options: ['26°–45° doğu boylamları, 36°–42° kuzey enlemleri', '26°–45° batı boylamları, 36°–42° güney enlemleri', '36°–42° doğu boylamları, 26°–45° kuzey enlemleri', '20°–40° doğu boylamları, 30°–40° kuzey enlemleri', '30°–45° doğu boylamları, 42°–46° kuzey enlemleri'], answer: 0, explanation: 'Türkiye 26°–45° doğu meridyenleri ile 36°–42° kuzey paralelleri arasındadır.' },
  { id: 'co8', category: 'cografya', difficulty: 'Kolay', question: 'Pamukkale travertenleri hangi ilimizdedir?', options: ['Muğla', 'Denizli', 'Antalya', 'Burdur', 'Aydın'], answer: 1, explanation: 'Pamukkale travertenleri Denizli\'dedir ve UNESCO Dünya Mirası Listesi\'ndedir.' },
  { id: 'va1', category: 'vatandaslik', difficulty: 'Kolay', question: '1982 Anayasası\'na göre yasama yetkisi kime aittir?', options: ['Cumhurbaşkanına', 'TBMM\'ye', 'Anayasa Mahkemesine', 'Danıştaya', 'Yüksek Seçim Kuruluna'], answer: 1, explanation: 'Yasama yetkisi Türk Milleti adına TBMM tarafından kullanılır; devredilemez.' },
  { id: 'va2', category: 'vatandaslik', difficulty: 'Kolay', question: 'Milletvekili seçilebilmek için en az kaç yaşını doldurmak gerekir?', options: ['18', '21', '25', '30', '35'], answer: 0, explanation: '2017 Anayasa değişikliğiyle seçilme yaşı 25\'ten 18\'e indirilmiştir.' },
  { id: 'va3', category: 'vatandaslik', difficulty: 'Kolay', question: 'Cumhurbaşkanı kaç yılda bir seçilir?', options: ['4', '5', '6', '7', '8'], answer: 1, explanation: 'Cumhurbaşkanı ve TBMM seçimleri beş yılda bir, aynı gün yapılır.' },
  { id: 'va4', category: 'vatandaslik', difficulty: 'Kolay', question: 'TBMM kaç milletvekilinden oluşur?', options: ['550', '600', '650', '500', '700'], answer: 1, explanation: '2017 değişikliğiyle milletvekili sayısı 550\'den 600\'e çıkarılmıştır.' },
  { id: 'va5', category: 'vatandaslik', difficulty: 'Orta', question: 'Anayasa\'ya göre "Egemenlik kayıtsız şartsız" kimindir?', options: ['Cumhurbaşkanının', 'TBMM\'nin', 'Milletin', 'Hükümetin', 'Millet Meclisinin'], answer: 2, explanation: 'Anayasa m.6: "Egemenlik, kayıtsız şartsız Milletindir."' },
  { id: 'va6', category: 'vatandaslik', difficulty: 'Kolay', question: 'İl genel yönetiminin başı kimdir?', options: ['Belediye başkanı', 'Vali', 'Kaymakam', 'Muhtar', 'İl müdürü'], answer: 1, explanation: 'Vali, ilde devletin ve hükümetin temsilcisidir.' },
  { id: 'va7', category: 'vatandaslik', difficulty: 'Kolay', question: 'Belediye başkanı ve muhtar kaç yılda bir seçilir?', options: ['4', '5', '6', '7', '8'], answer: 1, explanation: 'Mahalli idareler seçimleri beş yılda bir yapılır.' },
  { id: 'va8', category: 'vatandaslik', difficulty: 'Zor', question: 'Siyasi parti kurmak için en az kaç Türk vatandaşının bir araya gelmesi gerekir?', options: ['20', '25', '30', '50', '40'], answer: 2, explanation: 'En az 30 Türk vatandaşı bir araya gelerek siyasi parti kurabilir.' },
  { id: 'gu1', category: 'guncel', difficulty: 'Orta', question: '2026 FIFA Dünya Kupası hangi ülkelerde düzenlenecektir?', options: ['Brezilya – Arjantin', 'ABD – Kanada – Meksika', 'İspanya – Portekiz', 'Almanya – Fransa', 'Rusya – Katar'], answer: 1, explanation: '2026 Dünya Kupası ABD, Kanada ve Meksika\'nın ortak ev sahipliğinde düzenlenecektir.' },
  { id: 'gu2', category: 'guncel', difficulty: 'Orta', question: '2026 Kış Olimpiyatları nerede düzenlenecektir?', options: ['Pekin', 'Milano – Cortina (İtalya)', 'Vancouver', 'Seul', 'Salt Lake City'], answer: 1, explanation: '2026 Kış Olimpiyatları İtalya\'nın Milano-Cortina bölgesinde yapılacaktır.' },
  { id: 'gu3', category: 'guncel', difficulty: 'Orta', question: 'EURO 2024 Avrupa Futbol Şampiyonası\'nı hangi ülke kazanmıştır?', options: ['İngiltere', 'Fransa', 'İspanya', 'Almanya', 'İtalya'], answer: 2, explanation: 'İspanya, finalde İngiltere\'yi yenerek EURO 2024 şampiyonu olmuştur.' },
  { id: 'gu4', category: 'guncel', difficulty: 'Zor', question: '2024 Nobel Ekonomi Ödülü\'nü kazanan Türk bilim insanı kimdir?', options: ['Aziz Sancar', 'Daron Acemoğlu', 'Canan Dağdeviren', 'Gazi Yaşargil', 'Celal Şengör'], answer: 1, explanation: 'Daron Acemoğlu; Simon Johnson ve James Robinson ile birlikte 2024 Nobel Ekonomi Ödülü\'nü kazanmıştır.' },
  { id: 'gu5', category: 'guncel', difficulty: 'Kolay', question: 'Türkiye\'nin ilk astronotu kimdir?', options: ['Alper Gezeravcı', 'Cengiz Topel', 'Sabiha Gökçen', 'Vecihi Hürkuş', 'Tuva Cihangir Atasever'], answer: 0, explanation: 'Alper Gezeravcı, 2024 yılında Uluslararası Uzay İstasyonu\'na giden ilk Türk astronot olmuştur.' },
  { id: 'gu6', category: 'guncel', difficulty: 'Orta', question: '98. Akademi Ödülleri\'nde (2026) En İyi Film ödülünü hangi yapım kazanmıştır?', options: ['Oppenheimer', 'One Battle After Another', 'Barbie', 'Dune: Part Two', 'The Brutalist'], answer: 1, explanation: '"One Battle After Another" filmi 98. Akademi Ödülleri\'nde En İyi Film seçilmiştir.' },
  { id: 'gu7', category: 'guncel', difficulty: 'Orta', question: '2025\'te Sardes\'in UNESCO listesine alınmasıyla Türkiye\'nin listedeki varlık sayısı kaça yükselmiştir?', options: ['19', '20', '21', '22', '23'], answer: 3, explanation: 'Sardes ve Bin Tepeler\'in eklenmesiyle sayı 22\'ye yükselmiştir.' },
  { id: 'gu8', category: 'guncel', difficulty: 'Zor', question: '2026 Avrupa Şampiyonası\'nda 13. Avrupa şampiyonluğuna ulaşan güreşçimiz kimdir?', options: ['Taha Akgül', 'Rıza Kayaalp', 'Yasemin Adar', 'Süleyman Karadeniz', 'Celal Atik'], answer: 1, explanation: 'Rıza Kayaalp, 2026 Avrupa Şampiyonası\'nda altın madalya kazanarak 13. şampiyonluğuna ulaşmıştır.' },
];
